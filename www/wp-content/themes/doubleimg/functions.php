...
function widget(){
	register_sidebar(array(
		'name' => __('dimg footer widget', 'wpb'),
		'id' => 'dimg-footer-widget',
		'description' => '',
		'class' => 'dimg-footer-widget',
		'before_widget' => '<div class="dimg-widget">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="dimg-footer-widget-title">',
		'after_title' => '</h4>',
	));
}
